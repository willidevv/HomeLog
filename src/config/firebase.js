...
// export const appId = typeof __app_id !== 'undefined' ? __app_id : 'homelog-default-app';
...
// export const auth = getAuth(app);
// export const db = getFirestore(app);
// export const appId = firebaseConfig.appId; // Jika Anda mengekspor appId untuk digunakan di App.jsx
