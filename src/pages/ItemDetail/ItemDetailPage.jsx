...
export default function ItemDetailView() {
  ...
  const { activeRoom, activeItem, filteredRecords, handleDelete } = useData();

  return (
    <div className="animate-in fade-in slide-in-from-right-8 duration-300">
      <button
        onClick={() => goBack('room')}
        className="flex items-center gap-2 text-navy-300 hover:text-gold-400 transition-colors mb-6"
      >
        ...
        <div className="lg:col-span-1">
          <div className="bg-navy-900/40 backdrop-blur-sm border border-navy-800/50 rounded-2xl p-6 sticky top-24">
            <div className="flex justify-between items-start mb-5">
              ...
              <button
                onClick={() => openModal('item', activeItem)}
            ...
            {activeItem?.description && (
              <div className="mt-5 mb-6">
                <span className="text-xs font-medium text-navy-400 uppercase tracking-wider mb-2 block">
                  Deskripsi
                </span>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-medium text-cream-50">
                    {activeItem?.purchaseDate || 'Tidak ada data'}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm font-medium text-green-400">
                      {filteredRecords.length} catatan perawatan
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 pb-5 border-b border-navy-800/30">
              <div>
                ...
                <p className="text-sm text-navy-300 mt-1">
                  Catat dan pantau aktivitas perawatan barang ini untuk memperpanjang umur aset.
                </p>
              </div>
              <button
                onClick={() => openModal('maintenance')}
                className="bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white px-5 py-2.5 rounded-xl flex items-center gap-2 transition-all duration-300 shadow-lg shadow-gold-500/25 hover:shadow-gold-500/35 hover:-translate-y-0.5 active:translate-y-0 font-medium text-sm"
              >
            ...
            {filteredRecords.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-navy-300 max-w-md mx-auto mb-8">
                  Mulai catat perawatan untuk memperpanjang umur barang dan menjaga nilai aset.
                </p>
                <button
                  onClick={() => openModal('maintenance')}
                  className="bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white px-6 py-2.5 rounded-xl flex items-center gap-2 transition-all duration-300 shadow-lg shadow-gold-500/25 mx-auto font-medium text-sm"
                >
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 gap-3">
                          ...
                          <div className="flex items-center gap-3 flex-wrap">
                            ...
                            <div className="flex gap-1.5">
                              <button
                                onClick={() => openModal('maintenance', record)}
                                className="p-1.5 text-navy-400 hover:text-gold-400 hover:bg-gold-500/10 rounded-lg transition-all duration-200"
                                title="Edit"
                              >
                              ...
                              <button
                                ...
                                className="p-1.5 text-navy-400 hover:text-rose-400 hover:bg-rose-500/10 rounded-lg transition-all duration-200"
                                title="Hapus"
                              >
